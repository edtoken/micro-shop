...
/***/ function(module, exports, __webpack_require__) {
	...
	var _appApp = __webpack_require__(3);

	var _appApp2 = _interopRequireDefault(_appApp);

	var _appShop = __webpack_require__(193);
	...
	var upsellProductsNames = ['Шетка для чистки', 'Средство для стирки', 'Стельки', 'Спрей для обуви', 'Краска', 'Шнурки', 'Липучки', 'Наклейки', 'Крутая пацанская кепка', 'Стиральная машина'];
	...
	(function () {
	  ...
	  */
		function getItemById(id) {
			return _underscore2['default'].find(ITEMS, function (item) {
				return item.id === id;
			});
		}
	  ...
	  */
		...
		while (count > 0) {
			...
			// GENERATE UPSELLS
			var upsellProductsCount = upsellProductsNames.length / 6;

			while (upsellProductsCount > 0) {
				// generate upsell
				var upsellProductId = MAIN_PRODUCTS_COUNT + getRandom(1, MAIN_PRODUCTS_COUNT / 4 / upsellProductsCount);
				var upsellProduct = getItemById(upsellProductId);
				if (!upsellProduct) {
					var upsellProductData = genUpsellProductData(upsellProductId);
					upsellProductData.name = upsellProductsNames[getRandom(0, upsellProductsNames.length - 1)];
					upsellProduct = new _appShop.UpsellProduct(upsellProductData);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var App = (function () {
		function App(config) {
			...
			this.config = config;
			this.shop = new _Shop2['default']({ items: this.config.items });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _get = __webpack_require__(168)['default'];

	var _inherits = __webpack_require__(181)['default'];
	...
	var _Validator = __webpack_require__(192);
	...
	var PageComponent = (function (_Component) {
		...
		function PageComponent() {
			...
			_get(Object.getPrototypeOf(PageComponent.prototype), 'constructor', this).apply(this, arguments);
		}
	...
	var IndexPage = (function (_PageComponent) {
		_inherits(IndexPage, _PageComponent);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Object$getOwnPropertyDescriptor = __webpack_require__(169)["default"];
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = function(KEY, exec){
	  var $def = __webpack_require__(177)
	    ...
	    , exp  = {};
	  exp[KEY] = exec(fn);
	  $def($def.S + $def.F * __webpack_require__(180)(function(){ fn(1); }), 'Object', exp);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Object$create = __webpack_require__(182)["default"];

	var _Object$setPrototypeOf = __webpack_require__(184)["default"];
	...
	module.exports = {
	  set: Object.setPrototypeOf || ('__proto__' in {} ? // eslint-disable-line
	    function(test, buggy, set){
	      try {
	        set = __webpack_require__(190)(Function.call, getDesc(Object.prototype, '__proto__').set, 2);
	        set(test, []);
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */
	Validator.validators.boolean = function (value) {
	 ...
	 * @returns {(false|{msg:String})}
	 */
	Validator.validators.integer = function (value) {
	 ...
	 * @returns {*}
	 */
	Validator.validators.positive = function (value) {
	 ...
	 * @returns {(false|{msg:String})}
	 */
	Validator.validators.float = function (value) {
	 ...
	 * @returns {(false|{msg:String})}
	 */
	Validator.validators.string = function (value) {
	 ...
	 * @returns {(false|{msg:String})}
	 */
	Validator.validators.required = function (value) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _extensionsEvents = __webpack_require__(194);
	...
	var ShowUpsellPopup = (function (_Base) {
		_inherits(ShowUpsellPopup, _Base);

		function ShowUpsellPopup() {
			_classCallCheck(this, ShowUpsellPopup);
	  ...
	  */
		...
		_createClass(Product, [{
			...
			value: function set(key, val, options) {
				...
				this._attributes = _underscore2['default'].clone(current);
	...
	var UpsellProduct = (function (_Product2) {
		_inherits(UpsellProduct, _Product2);

		//upsellSpecifications: [UpsellAvailabalitySpecification]

		function UpsellProduct(data, options) {
			_classCallCheck(this, UpsellProduct);
